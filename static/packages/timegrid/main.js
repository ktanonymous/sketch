    ...
    */
    var TimeGridEventRenderer = /** @class */ (function (_super) {
        ...
        TimeGridEventRenderer.prototype.attachSegs = function (segs, mirrorInfo) {
            ...
            const segsByColLength = segsByCol.length;
            for (var col = 0; col < segsByColLength; col++) {
        ...
        TimeGridEventRenderer.prototype.computeSegHorizontals = function (segs) {
            ...
            if ((level0 = levels[0])) {
                const level0Length = level0.length;
                for (i = 0; i < level0Length; i++) {
        ...
        TimeGridEventRenderer.prototype.computeSegForwardBack = function (seg, seriesBackwardPressure, seriesBackwardCoord) {
            ...
            if (seg.forwardCoord === undefined) { // not already computed
                ...
                // forward segments
                const forwardSegsLength = forwardSegs.length;
                for (i = 0; i < forwardSegsLength; i++) {
    ...
    function computeSlotSegCollisions(seg, otherSegs, results) {
        ...
        for (var i = 0; i < otherSegsLength; i++) {
    ...
    var TimeGridSlicer = /** @class */ (function (_super) {
        ...
        TimeGridSlicer.prototype.sliceRange = function (range, dayRanges) {
            ...
            for (var col = 0; col < dayRangesLength; col++) {
